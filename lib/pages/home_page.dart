      ...
      SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                Container(child: const Text("  Hi,", style: TextStyle(fontSize: 23, color: primary, fontWeight: FontWeight.w500),),),
                const SizedBox(height: 5,),
                Container(child: const Text("Let's Find Your Doctor", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600),)),
                const SizedBox(height: 15,),
                const CustomTextBox(),
                const SizedBox(height: 25,),
                Container(child: const Text("Categories", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),)),
                ...
                const SizedBox(height: 25,),
                Container(child: const Text("Popular Doctors", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),)),
                const SizedBox(height: 10),
                SingleChildScrollView(
                  padding: const EdgeInsets.only(bottom: 5),
                  scrollDirection: Axis.horizontal,
